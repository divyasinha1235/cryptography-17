...
//matrix creaction of 5X5 matrix
...
int main()
{
        ...
        // insertion of the key  entered by the user into the table
         for(i=0;i<5;++i)
        {
           for(j=0;j<5;++j)
           {
          ...
          int val=97;      //ASCII values to be taken for the alphabets that is assing in the variable val.
      
	  //insertion of the other alphabets in the table or matrix 
       for(i=0;i<5;++i)
       {
           for(j=0;j<5;++j)
           {
        ...
        printf("The  matrix table created is :\n");
        for(i=0;i<5;++i)
        {
            for(j=0;j<5;++j)
           {
        ...
        for(i=-1;i<l;++i)
       {
        ...
        for(i=-1;i<l;++i)
        {
         ...
         printf("\nThe cipher has to enter %d  char. It is either 'x' or 'z'\n",count);
        ...
        for(k1=1;k1<=length;++k1)
        {
           for(i=0;i<5;++i)
           {
            ...
            else //when the column are same 
            if(c1==c2)
            {
                cipher_text[k1]=table[(r1+1)%5][c1];
                cipher_text[k1+1]=table[(r2+1)%5][c1];
            }
            else    //when there is no row and column are same then 
            {
